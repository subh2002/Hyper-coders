...
<body>
     ...
     <div class="header">
          ...
          <a href="farmerHomepage.php"><img id="logo" src="agro.png"></a>
     ...
     <!-- <ul id="delivery-progress">
         <li class="delivery-step">
           <i class="fas fa-people-carry order order1"></i><br><i class="fa fa-check aria" aria-hidden="true"></i><br><button class="selectsionz">Packing</button>
         </li>
         <li class="delivery-step">
           <i class="fas fa-truck order order2"></i><br><i class="fa fa-check aria" aria-hidden="true"></i><br><button class="selectsionz">Dispatch</button>
        </li>
        <li class="delivery-step">
           <i class="fas fa-road order order3"></i><br><i class="fa fa-refresh aria" aria-hidden="true"></i><br><button class="selectsionz">Half way </button>
        </li>
           <i class="delivery-step"><i class="fas fa-map-marker-alt order order4"></i><br><i class="fa fa-times aria" aria-hidden="true"></i><br><button class="selectsionz">Reached</button>
        </li>
v    </ul> -->
...
<table>
        ...
        <tr>  
             <td>
                ...
                <div class="grp1 movedown">
                    <div class="col1 t1"><b> Delivery time</b> </div>
            ...
            <td>
                ...
                <div class="grp2 movedown">
                    ...
                    <div class="col3 t1"><b>Delivery date</b></div>
                    <div class="col4">
     ...
     <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
               <p><u><a href="#">Quick Farm</a></u> is a Multitrading Company for farmers ang traders</p>
               <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">Quick Farm</a></p>
          </div>
          </hr>
     </div>
