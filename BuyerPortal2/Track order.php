      ...
      <div class="card">
        <div class="row d-flex justify-content-between px-3 top">
          <div class="d-flex">
            <h5>
              ORDER
              <span class="text-primary font-weight-bold">#ODI2596146</span>
            </h5>
          </div>
          <div class="d-flex flex-column text-sm-right">
            <p class="mb-0">
              Expected Arrival <span class="font-weight-bold">28 March 2023</span>
            </p>
            <p>
              Tracking ID: <span class="font-weight-bold">2374723467163473124234</span>
            </p>
          </div>
        </div>
